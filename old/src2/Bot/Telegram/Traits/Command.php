                ...
                switch ($val['command']) {
                    ...
                    case "/idan":
                        ...
                        if (!empty($val['salt'])) {
                            ...
                            $this->textReply(
                                "Sebutkan ID Anime yang ingin kamu cari !",
                                null,
                                $this->event['message']['message_id'],
                                array(
                                "reply_markup"=>json_encode(
                    ...
                    case '/qmanga':
                        ...
                        if (!empty($val['salt'])) {
                            ...
                            $this->textReply(
                                "Manga apa yang ingin kamu cari?",
                                null,
                                $this->event['message']['message_id'],
                                array(
                                "reply_markup"=>json_encode(
                    ...
                    case "/idma":
                        ...
                        if (!empty($val['salt'])) {
                            ...
                            $this->textReply(
                                "Sebutkan ID Manga yang ingin kamu cari !",
                                null,
                                $this->event['message']['message_id'],
                                array(
                                "reply_markup"=>json_encode(
                    ...
                    case '/whatanime':
                        ...
                        if (!empty($val['salt']) && $val['salt']!==false) {
                            ...
                            if (isset($st['docs'][0]) && $st['docs'][0] !==false) {
                                ...
                                $x = $this->tel->sendVideo("https://webhooks.redangel.ga/telegram/video/".$hash_fn.".mp4", $this->room, "Berikut ini adalah cuplikan singkat dari anime yang mirip.\n\nDurasi : ".$fd($dur['start'])." - ".$fd($dur['end']), $this->event['message']['message_id']);
                            ...
                            if (isset($this->event['message']['reply_to_message']['photo'][1])) {
                                ...
                                if ($val['salt'] === false) {
                                    ...
                                    $this->textReply(
                                        "Balas pesan dengan screenshot anime yang ingin kamu tanyakan !",
                                        null,
                                        $this->event['message']['message_id'],
                                        array(
                                        "reply_markup"=>json_encode(
