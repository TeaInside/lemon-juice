            ...
            if ($val['type'] == "text") {
                if (is_array($val['content'])) {
                    foreach ($val['content'] as $msg) {
                        $this->tel->sendMessage($msg, $val['to'], $val['reply_to'], $val['parse_mode']);
                    }
                } else {
                ...
                if (is_array($val['content'])) {
                    foreach ($val['content'] as $photo) {
                        $this->tel->sendPhoto($photo, $val['to'], $val['reply_to'], $val['parse_mode']);
                    }
                } else {
                    $this->tel->sendPhoto($val['content'], $val['to'], $val['reply_to'], $val['parse_mode']);
                }
            }
        }
    }
